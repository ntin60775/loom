...
## 16. Не входит в scope v1

- Memory layer (session/semantic/episodic дорожки)
- Embedding-based retrieval
- Multi-agent coordination (несколько параллельных workers)
- Publish адаптеры (PR/MR через GitHub/GitLab API)
- Github/GitLab CI интеграция
