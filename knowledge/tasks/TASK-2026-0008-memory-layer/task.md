...
| INV-4 | Явная сборка контекста: контекст собирается явно, без скрытых состояний сессии агента. Time-based variance в relevance scoring допускается. | verified |
